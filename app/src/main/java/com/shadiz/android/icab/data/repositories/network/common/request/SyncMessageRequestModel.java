...
public class SyncMessageRequestModel extends BaseModelRequest {
    String date_from;
    /**
     ...
     */
    public SyncMessageRequestModel(String date_from, String device_uuid, String login, String device_platform) {
        super(device_uuid, login, device_platform);
        this.date_from = date_from;
    }
    public SyncMessageRequestModel(DeviceRequestModel deviceModelRequest, String date_from) {
