...
public interface ClientApi {
    ...
    Call<SyncMessageModelResponce> getStatusMessage(@Field("date_from") String date, @Field("device_uuid") String device_uuid, @Field("login") String login, @Field("device_platform") String android);
